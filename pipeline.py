...
# SetItemKey("item_name", "1083030"),
  ...
  ExternalProcess("sleep", [ "sleep", NumberConfigValue(name="example.sleep", title="Time to sleep", description="The example project will sleep n seconds.", min=1, max=15, default="5")]),
